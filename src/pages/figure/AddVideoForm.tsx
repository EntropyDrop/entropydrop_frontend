        ...
        <div className="flex-1 overflow-y-auto custom-scrollbar pr-2 pb-16 min-h-0 animate-in fade-in duration-300 flex flex-col gap-6">
            ...
            <div>
                ...
                >
                    ...
                    <span>{current.figureForum.backToVideos}</span>
                </button>
            </div>
            ...
            <div className="bg-black/20 border border-white/10 p-5 sm:p-6 flex flex-col gap-4">
                <div className="flex justify-between items-start mb-2">
                    <h3 className={`text-base sm:text-lg font-bold text-white flex items-center gap-2 ${current.fontClass}`}>
                        ...
                        <span>{current.figureForum.addNewVideo}</span>
                    </h3>
                </div>
                ...
                <form onSubmit={handleCreateVideo} className="flex flex-col gap-4">
                    ...
                    <div className="flex flex-col gap-1.5">
                        <label className={`text-xs text-white/60 uppercase ${current.fontClass}`}>{current.figureForum.youtubeUrlLabel}</label>
                        <input
                            type="text"
                    ...
                    <div className="flex gap-3 justify-end mt-4">
                        ...
                        >
                            {current.figureForum.publishVideo}
                        </button>
                    </div>
                </form>
            </div>
