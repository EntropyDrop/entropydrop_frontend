        ...
        agentModes: {
            ...
            cards: [
                ...
                },
                {
                    ...
                    status: '脚本助手已可用',
                    scope: '当前实体及其全部组件',
                    description: '围绕一个实体调整结构、外观、物理参数和控制代码，适合反复打磨车辆与机械。',
                    entry: '对准实体按 C，打开编辑器中的 AI 助手。',
                    example: '只修改这辆越野车：调整悬挂结构和阻尼，并更新控制代码。',
                ...
                },
                {
                    ...
                    status: 'AI BUILD 已可用',
                    scope: '账号获授权的世界与实体',
                    description: '从世界视角查询位置、建造场景、协调多个实体，适合不局限于单个物体的任务。',
                    entry: '点击 HUD 中的 AI BUILD，描述建造需求。',
