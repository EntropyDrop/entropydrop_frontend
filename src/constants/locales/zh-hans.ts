...
电子邮箱：support@entropydrop.com`
    ...
    public_page: {
        ...
        articles: {
            ...
            list: [
                { id: 'skin-reconstruction', title: '图生皮肤的新路径：从规范化渲染到 Minecraft UV 重建', date: '2026-09-08', tags: ['Minecraft', '计算机视觉', '几何重建', '生成模型'], summary: '基于 SkingToolkit v104，介绍学习式前景提取、联合头部语义、跨面拓扑解码与最终材质拟合，说明可见头部的测试改善、未观察头底面的退步，以及候选模型与批量导出的验证边界。' },
