...
免费方案下生成的作品仅获得个人、学习、研究及非商业娱乐用途的使用许可，不得直接或间接用于商业销售、商业宣传、付费项目或其他营利活动。

在有效 Pro-Plus、Pro-Max 或页面明确标注具有商用许可的付费周期内生成的作品，您获得永久、全球、非独占的商业使用许可。即使之后订阅到期，该期间已经生成的作品仍可继续商用。该许可仅涵盖 EntropyDrop 对生成结果能够授予的权利，不包括第三方商标、角色、肖像、版权素材或其他第三方权利。
...
对于公开内容，您授予 EntropyDrop 一项全球范围、非独占、免许可费、可再许可的授权，以便我们存储、复制、转换和展示内容，提供搜索、分享、推荐、派生创作和社区功能，进行安全审查、内容审核和侵权处理，在合理范围内宣传服务，并对明确标注可用于模型改进的公开生成内容进行模型评估、微调或训练。

当您删除公开内容或将其设为私有后，我们将停止将其用于新的公开展示和新的训练任务。但是，已经完成的模型训练可能无法从模型参数中单独分离或逆向移除该内容；另有强制要求的除外。
...
• AI 生成与编辑：提示词、源图片、生成结果、中间结果、模型版本、参数、随机种子、公开状态和反馈，用于完成生成、保存历史、计费、故障恢复和模型改进；
...
您拒绝提供非必要信息不会影响基本功能；拒绝提供某项服务所必需的信息，可能导致相应功能无法使用。`
            ...
            {
                title: '5. 公开内容与私有内容',
                content: `如果您选择“公开”，生成结果、源图片及处理中间结果，提示词、作品名称、模型参数及派生关系，昵称、头像、角色皮肤及作者标识，以及公开收藏、点赞数量、论坛内容、面向世界或频道的 Space 聊天和 Space 市场资源可能向相应参与者或任何人公开。公开信息可能被其他用户查看、下载、截图、分享、建立链接或在平台外传播。即使您之后删除，第三方此前保存的副本也可能无法由我们控制。

对于免费方案，生成内容通常只能以公开方式保存。请在提交前检查界面上的公开状态，不要上传不希望公开的个人照片或敏感内容。在界面明确告知并取得相应授权后，我们可能使用公开生成内容、提示词及质量反馈进行模型评估、微调或训练。
