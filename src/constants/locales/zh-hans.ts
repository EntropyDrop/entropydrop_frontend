export default {
    ...
    termsOfService: {
        ...
        sections: [
            ...
            { title: '2. 知识产权与授权', content: '因您自身创作的作品归您所有。需要注意的是，您商业使用生成作品的权利取决于您的订阅方案：免费版用户生成的作品仅供个人学习、研究及非商业性娱乐用途使用，不得用于任何商业目的；在 Pro 订阅（包括 Pro-Plus 和 Pro-Max）有效期内生成的作品享有永久商用许可（即使订阅到期，该期间生成的作品仍可永久商用）。对于您设置为“公开”的作品，您授权 Entropydrop 拥有免费、不可撤销的公开展示、发布与模型微调/训练权。' },
