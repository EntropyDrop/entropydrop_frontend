export default {
    ...
    generate: {
        ...
        btnStart: '开始生成',
        btnGenerating: '正在构建...',
        queueStatusWaiting: '{count} 个任务正在排队',
        queueStatusWaitingSingle: '1 个任务正在排队',
        queueEstimatedTime: '约 {minutes} 分钟',
        queueProUpgradeHint: '升级为 PRO 享有优先排队特权',
        queueProUpgradeAction: '立即升级',
        queueProActiveHint: '已获得 PRO 优先排队特权',
        activeTasksTitle: '当前构建任务',
        completedHistoryTitle: '已完成历史',
        modelUnderMaintenanceTitle: '模型维护中',
        modelUnderMaintenanceMsg: '当前选择的模型正在维护中，请选择其他模型使用。',
        modeImageToSkin: '图生皮肤',
        modeTextToSkin: '文生皮肤',
        modeImageEditToSkin: '局部编辑生皮肤',
        queueReady: '准备就绪',
        emptyTitle: '准备好创造了吗？',
        ...
        licenseCommercialDesc: '在有效 Pro 期间生成的作品享有生成者永久商用许可；若设为公开，其他用户仍仅获得 CC BY-NC 4.0 非商业许可。',
        licenseNonCommercialDesc: '免费方案下生成的作品适用 CC BY-NC 4.0；在署名条件下可用于非商业目的、分享和修改。',
        licenseParentCommercialOwnerDesc: '本次生成将保留您的永久商用许可；若设为公开，其他用户仍仅获得 CC BY-NC 4.0 非商业许可。',
        licenseParentCommercialOtherDesc: '基于他人公开商用作品进行衍生生成，仅适用 CC BY-NC 4.0 非商业许可。',
        licenseParentNonCommercialDesc: '来源作品适用 CC BY-NC 4.0，本次生成结果仍仅限非商业使用。',
        licenseParentUnknownDesc: '来源作品许可未知，生成结果将保留未知许可，不会扩大授权范围。',
        licenseLoading: '正在确认许可…',
        licenseLoadingDesc: '正在检查来源作品，以确认生成后适用的许可。',
        licenseUnavailable: '暂时无法确认许可',
        licenseUnavailableDesc: '无法验证来源许可，请重新打开原皮肤或稍后重试。',
        licensePublicNotice: '作品设为公开后，其他用户仅获得 CC BY-NC 4.0 非商业使用权，商用许可仅属于您的账户。',
        licensePrivateNotice: '作品设为私有后，不会向其他用户公开，仅供您个人使用。',
        licenseProUpgradeHint: '订阅 Pro 即可享有生成者永久商用许可',
        licenseTermsLink: '查看 CC BY-NC 4.0 完整条款',
        licenseViewDetails: '查看详情',
        licenseHideDetails: '收起详情',
        licenseCommercialSummary: '在 Pro 期间生成的作品享有生成者永久商用许可。',
        licenseNonCommercialSummary: '免费方案下生成的作品适用 CC BY-NC 4.0，仅供个人非商业使用。',
        licenseParentCommercialOwnerSummary: '本次生成将保留您的永久商用许可。',
        licenseParentCommercialOtherSummary: '衍生生成仅获得 CC BY-NC 4.0 非商业许可。',
        licenseParentNonCommercialSummary: '来源作品适用 CC BY-NC 4.0，本次生成仅限非商业使用。',
        licenseParentUnknownSummary: '来源作品许可未知，本次生成保留未知许可。'
    },
    collection: {
        title: '我的收藏',
        ...
        uploadLicenseMessage: '上传即表示您确认拥有授予许可所需的权利，并同意将该皮肤以 CC BY-NC 4.0 许可提供：任何人可在署名条件下用于非商业目的、分享和修改。该许可不可撤销；删除皮肤不会撤销此前已合法取得的许可。',
        empty: '这里空落落的',
        create: '创建收藏夹',
        name: '名称',
        visibility: '可见性',
...
在保存独立创作或导入的皮肤前，界面将要求您确认拥有所选许可所需的权利。在界面提供许可选择时，有效 Pro 账户可以为该保存账户选择页面显示的 EntropyDrop 商用许可；该选择不会产生、清除或转移您原本不拥有的任何第三方权利。商用选项不可用或您选择 CC BY-NC 4.0 时，作品按非商业许可记录。无论生成者选择哪种许可，作品保存为公开后，其他用户均仅获得 CC BY-NC 4.0；生成者专属商用许可不会扩展给他人。保存为私有不会向新用户授予公开访问。许可记录功能启用前上传的皮肤标记为“许可未知”。CC BY-NC 4.0 许可一经有效授予即不可撤销；删除作品不会撤销第三方此前已经合法取得的许可。
...
由于 AI 技术特点，其他用户可能获得相同或相似结果。我们不会仅因您生成或使用某一结果而承诺向您授予排他性权利。`
            },
            {
                ...
                content: `皮肤的公开或私有状态在创建时确定，创建后不可更改。当您将作品保存为“公开”时，其生成结果、提示词、源图片、处理中间结果、作者昵称、头像、模型参数及相关公开互动信息可能被任何人通过页面、分享链接或公开接口访问、展示或下载。请勿将包含身份证件、联系方式、私人照片、未成年人信息或其他敏感信息的内容设为公开。
...
当您删除公开内容后，我们将停止将其用于新的公开展示和新的训练任务。但是，已经完成的模型训练可能无法从模型参数中单独分离或逆向移除该内容，第三方此前依据不可撤销的公共许可已经取得的权利也不受影响；另有强制要求的除外。
...
任何互联网服务都无法保证绝对安全。如发生可能影响您权益的个人信息泄露、篡改或丢失，我们将采取补救措施，并按适用要求通知受影响用户及有关机构。`
            ...
            {
                title: '11. 您的权利',
                content: `在适用范围内，您可以查询、复制或导出个人信息，更正或补充不准确的信息，管理好友、解除好友关系或屏蔽其他用户，删除产品支持删除的消息、作品、地址或账号，撤回同意，限制或拒绝特定处理，注销账号，要求说明个人信息处理规则，或对账号、内容及隐私处理决定提出申诉。
...
电子邮箱：support@entropydrop.com`
    ...
    mcmodal: {
        ...
        previousPublicLicense: '该作品曾经公开；此前已合法取得的 CC BY-NC 4.0 许可仍然有效。',
        viewLicenseTerms: '查看 CC BY-NC 4.0 完整条款',
        thirdPartyRightsNotice: '许可仅覆盖许可人有权授予的权利，不包括第三方商标、角色、肖像、版权素材或其他第三方权利。',
        licenseViewDetails: '查看详情',
        licenseHideDetails: '收起详情',
        creatorCommercialSummary: '您拥有该作品的生成者永久商用许可。',
        publicNonCommercialSummary: '任何人均可免费用于个人与非商业目的，需署名。',
        otherUserCommercialSummary: '公开作品，商用许可仅属于生成者；您获得 CC BY-NC 4.0 非商业许可。',
        unknownSummary: '该作品上传于许可系统启用前，使用前请联系上传者确认。'
    },
    space_api_keys: {
        "title": "Space API Keys",
        "description": "管理 Agent 访问 Space 使用的密钥。密钥属于你的账号，与游戏内设置中的 API Key 共用。",
        "signInTitle": "登录后管理你的密钥",
        "signInHelp": "请使用导航栏的登录按钮。无需进入世界，即可在这里创建和管理密钥。",
        "guideTitle": "连接你的 Agent",
        "guideHelp": "把后端地址、密钥和公开 Skill 交给 Agent。Agent 通过 spaceAPI 发送 HTTP 请求；实体代码通过 entityAPI（self / ctx）运行。",
        "runtimeHelp": "查询保存位置前，请先进入在线世界。修改实体代码和默认属性前先停止实体，运行时保持浏览器在线。localhost 仅适用于同一台机器上的 Agent。",
        "backend": "后端地址",
        "copyInstructions": "复制连接说明",
        "instructionsCopied": "已复制，发送前请补上你的密钥和任务。",
        "copyFailed": "复制失败，请选中文字后手动复制。",
        "createTitle": "创建密钥",
        "nameLabel": "密钥名称",
        "namePlaceholder": "例如：我的编程 Agent",
        "fullPermissions": "完整 Space 权限",
        "permissionHelp": "所有密钥（包括已有密钥）均拥有完整 Space 权限：读取自身位置、创建与编辑自有实体、启动／停止实体、建造方块组。仍需遵守世界访问、实体所有权和配额限制。若启用托管，需另行设置消费预算。",
        "create": "创建密钥",
        "working": "处理中…",
        "secretTitle": "请立即复制新密钥",
        "secretHelp": "完整密钥仅在此时显示一次。请妥善保存；离开页面或退出登录后将不再显示。",
        "secretLabel": "新的 Space API Key",
        "copy": "复制密钥",
        "copied": "已复制 API Key。",
        "dismiss": "隐藏密钥",
        "listTitle": "我的密钥",
        "refresh": "刷新",
        "loading": "正在加载密钥…",
        "empty": "还没有 API Key。在上方创建一个，连接你的 Agent。",
        "created": "创建时间",
        "lastUsed": "最近使用",
        "never": "尚未使用",
        "revoke": "撤销",
        "revokeTitle": "撤销这个 API Key？",
        "revokeHelp": "使用「{name}」的 Agent 将失去访问权限。撤销后无法恢复此密钥，但可以创建新密钥。",
        "revoked": "已撤销 API Key。",
        "keyLimit": "此账号已达到 20 个密钥的上限。请先撤销不再使用的密钥。",
        "requestFailed": "请求未能完成。请先刷新密钥列表确认结果，再决定是否重试。"
},
    space_page: {
        ...
        features: [
            ...
            },
            {
                ...
                description: '点击 HUD 中的 AGENT BUILD 接入外部 Agent，通过 spaceAPI 按自然语言需求建造场景与实体；对准实体按 C 呼出终端，通过自然语言即时生成 entityAPI 控制脚本，实现自主悬停、航向巡航、姿态平稳与传感器闭环控制。',
        ...
        agentModes: {
            title: '两种 AI 接入方式，按任务选择',
            subtitle: '通过外部 Agent Build 建造世界，或在实体编辑器中生成控制脚本。',
            scopeLabel: '目标范围',
            entryLabel: '从这里开始',
            ...
            authNote: '模型 API Key 用于连接实体编辑器的 AI 助手；spaceAPI Key 为外部 Agent 授予完整 Space 权限，仍受资源归属与配额约束。只交给可信的 Agent，不再使用时及时撤销。',
            cards: [
                {
                    id: 'external',
                    icon: 'pixelarticons:zap',
                    title: 'Agent Build · 外部 Agent',
                    status: '开箱即用',
                    scope: '全自动读取世界位置、生成体素并执行代码建造',
                    description: '复制下方 Prompt 给你的外部 Agent，或在 Space 中打开 AGENT BUILD 查看同一份接入指南并管理 API Key。Agent 阅读公开 Skill 后，会向你索取 spaceAPI Key，再查询位置并执行建造。',
                    entry: '复制本卡片的 Prompt，或点击 HUD 中的 AGENT BUILD；按提示将 spaceAPI Key 交给可信的 Agent，并保持 Space 在线。',
                ...
                },
                {
                    ...
                    status: '脚本助手已可用',
                    scope: '当前实体及其全部组件',
                    description: '围绕当前实体及其组件生成和改进控制脚本，适合反复打磨车辆与机械。检查生成的代码后，在编辑器中点击 Apply 应用。',
                    entry: '对准实体按 C，打开编辑器中的 AI 助手。',
                    example: '为这辆越野车生成转向与悬挂阻尼控制脚本。',
                    availability: '目前可生成组件脚本，点击 Apply 应用；完整属性编辑与实体级 API 授权为后续扩展。',
                },
            ],
        },
        agentSetup: {
    ...
    public_page: {
        ...
        articles: {
            ...
            list: [
                { id: 'skin-reconstruction', title: '图生皮肤的新路径：从规范化渲染到 Minecraft UV 重建', date: '2026-09-21', tags: ['Minecraft', '计算机视觉', '几何重建', '生成模型'], summary: '基于线上 SkingToolkit v101/v101c，介绍固定几何候选、SigLIP2 语义路由、Minecraft 前景模型、头饰整体分层、可见材质拟合与皇冠重渲染修正，并说明训练证据与当前泛化边界。' },
