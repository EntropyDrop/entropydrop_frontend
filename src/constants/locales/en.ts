export default {
    ...
    generate: {
        ...
        queueStatusWaiting: '{count} tasks waiting in queue',
        queueStatusWaitingSingle: '1 task waiting in queue',
        queueEstimatedTime: '~{minutes} min',
        queueProUpgradeHint: 'Upgrade to PRO for priority queue access',
        queueProUpgradeAction: 'Upgrade',
        queueProActiveHint: 'PRO priority queue access active',
        activeTasksTitle: 'Active Tasks',
        completedHistoryTitle: 'Completed History',
        modelUnderMaintenanceTitle: 'Model Under Maintenance',
        modelUnderMaintenanceMsg: 'The selected model is under maintenance. Please choose another model.',
        modeImageToSkin: 'Image to Skin',
        modeTextToSkin: 'Text to Skin',
        modeImageEditToSkin: 'Image Edit to Skin',
        queueReady: 'READY',
        ...
        licenseCommercialDesc: 'Works generated during an active Pro subscription enjoy a perpetual creator commercial license. If public, others receive only CC BY-NC 4.0.',
        licenseNonCommercialDesc: 'Works generated under the free tier are offered under CC BY-NC 4.0 for non-commercial use, sharing, and remixing with attribution.',
        licenseParentCommercialOwnerDesc: 'This generation retains your perpetual commercial license. If public, other users receive only CC BY-NC 4.0.',
        licenseParentCommercialOtherDesc: 'Generations derived from another user’s work receive only a CC BY-NC 4.0 non-commercial license.',
        licenseParentNonCommercialDesc: 'The source work is under CC BY-NC 4.0; this generation remains non-commercial.',
        licenseParentUnknownDesc: 'The source license is unknown; this generation retains unknown status and does not expand rights.',
        licenseLoading: 'Checking license...',
        licenseLoadingDesc: 'Checking the source skin to confirm the applicable license after generation.',
        licenseUnavailable: 'License unavailable',
        licenseUnavailableDesc: 'The source license could not be verified. Please reopen the original skin or try again.',
        licensePublicNotice: 'If set to Public, other users receive only CC BY-NC 4.0; commercial rights belong solely to your account.',
        licensePrivateNotice: 'If set to Private, this work is not shared publicly and remains accessible only to you.',
        licenseProUpgradeHint: 'Subscribe to Pro for perpetual commercial license',
        licenseTermsLink: 'View CC BY-NC 4.0 terms',
        licenseViewDetails: 'View details',
        licenseHideDetails: 'Hide details',
        licenseCommercialSummary: 'Works generated during Pro enjoy a perpetual creator commercial license.',
        licenseNonCommercialSummary: 'Works generated under the free tier are for non-commercial personal use under CC BY-NC 4.0.',
        licenseParentCommercialOwnerSummary: 'This generation retains your perpetual creator commercial license.',
        licenseParentCommercialOtherSummary: 'Derivations from others receive only CC BY-NC 4.0 non-commercial license.',
        licenseParentNonCommercialSummary: 'Source is under CC BY-NC 4.0; this generation remains non-commercial.',
        licenseParentUnknownSummary: 'Source license is unknown; this generation retains unknown license.'
    },
    collection: {
...
Email: support@entropydrop.com`
    ...
    mcmodal: {
        ...
        licenseViewDetails: 'View details',
        licenseHideDetails: 'Hide details',
        creatorCommercialSummary: 'You hold a perpetual, worldwide commercial-use license.',
        publicNonCommercialSummary: 'Free for personal and non-commercial use with attribution under CC BY-NC 4.0.',
        otherUserCommercialSummary: 'Commercial rights belong to the creator; you receive CC BY-NC 4.0 non-commercial license.',
        unknownSummary: 'Uploaded before license system was introduced; contact creator before use.'
    },
    space_api_keys: {
        "title": "Space API Keys",
        "description": "Manage the keys your agents use to access Space. Keys belong to your account and can also be managed in the in-game settings.",
        "signInTitle": "Sign in to manage your keys",
        "signInHelp": "Use the sign-in button in the navigation bar. You can create and manage keys here without entering a world.",
        "guideTitle": "Connect your agent",
        "guideHelp": "Give your agent the backend URL, a key and the public Skill. Agents send HTTP requests through spaceAPI; entity code calls entityAPI (self / ctx).",
        "runtimeHelp": "Enter the online world before requesting your saved position. Stop an entity before editing its code or defaults, and keep your browser online to run it. localhost works only for agents on this machine.",
        "backend": "Backend URL",
        "copyInstructions": "Copy connection instructions",
        "instructionsCopied": "Copied. Add your key and task before sending.",
        "copyFailed": "Copy failed. Select and copy the text manually.",
        "createTitle": "Create a key",
        "nameLabel": "Key name",
        "namePlaceholder": "e.g. My coding agent",
        "fullPermissions": "All Space permissions",
        "permissionHelp": "Every key, including existing keys, has full Space permissions to read your position, create and edit your entities, start/stop them, and build blocksets. World access, ownership and quotas still apply. Hosting, when available, requires an explicit spending budget.",
        "create": "Create key",
        "working": "Working…",
        "secretTitle": "Copy your new key now",
        "secretHelp": "This is the only time the full key is shown. Store it privately; it will disappear when you leave this page or sign out.",
        "secretLabel": "New Space API key",
        "copy": "Copy key",
        ...
        "empty": "No API keys yet. Create one above to connect your agent.",
        "created": "Created",
        "lastUsed": "Last used",
        "never": "Never",
        "revoke": "Revoke",
        "revokeTitle": "Revoke this API key?",
        "revokeHelp": "Agents using “{name}” will lose access. This key cannot be restored; you can create a new one.",
        "revoked": "API key revoked.",
        "keyLimit": "This account has reached the 20-key limit. Revoke an unused key before creating another.",
        "requestFailed": "The request could not be completed. Refresh the key list to check the result before trying again."
},
    space_page: {
        ...
        features: [
            ...
            },
            {
                ...
                description: 'Open AGENT BUILD in the HUD to connect an external agent, then describe structures or entities to build through spaceAPI. Aim at an entity and press C to open the editor, generating entityAPI controller code for autonomous hovering, waypoint cruising, and attitude stabilization in seconds.',
        ...
        agentModes: {
            title: 'Two AI integration methods, chosen for your task',
            subtitle: 'Build through an external Agent Build connection, or generate controller scripts in the entity editor.',
            ...
            authNote: 'A model API key connects the entity editor assistant to its model. A spaceAPI key grants an external agent full Space permissions, subject to ownership and quotas. Share it only with an agent you trust, and revoke it when no longer needed.',
            cards: [
                {
                    id: 'external',
                    icon: 'pixelarticons:zap',
                    title: 'Agent Build · External Agent',
                    status: 'Ready to use',
                    scope: 'Autonomous position querying, voxel planning & entity code execution',
                    description: 'Copy the prompt below to your external agent, or open AGENT BUILD in Space for the same guide and API key management. Your agent reads the public Skill and asks for a spaceAPI key before querying your position and building.',
                    entry: 'Copy this card’s prompt, or choose AGENT BUILD in the HUD. Give a trusted agent a spaceAPI key when asked and keep Space open.',
                ...
                },
                {
                    ...
                    title: 'Entity programming agent',
                    status: 'Script assistant available',
                    scope: 'The current entity and all its components',
                    description: 'Generate and refine controller scripts for one entity and its components while developing a vehicle or machine. Review the generated code and apply it in the editor.',
                    entry: 'Aim at an entity, press C, and open the editor’s AI assistant.',
                    example: 'Generate steering and suspension-damping controller code for this off-road vehicle.',
                    availability: 'Generate a component script and choose Apply today. Editing all properties and enforcing entity-scoped API access are planned extensions.',
                },
            ],
        },
        agentSetup: {
    ...
    public_page: {
        ...
        articles: {
            ...
            list: [
                { id: 'skin-reconstruction', title: 'From Normalized Renders to Minecraft UV Reconstruction', date: '2026-09-21', tags: ['Minecraft', 'Computer Vision', 'Geometry Reconstruction', 'Generative Model'], summary: 'Explains the production SkingToolkit v101/v101c stack: fixed geometry candidates, SigLIP2-conditioned routing, Minecraft foreground extraction, whole-headwear layer consistency, visible-material fitting, and crown correction through re-rendering evidence, with the limits of its training evidence and generalization.' },
