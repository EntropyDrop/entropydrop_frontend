...
Email: support@entropydrop.com`
    ...
    space_page: {
        ...
        agentModes: {
            ...
            sharedTitle: 'Shared direction: the spaceAPI',
            ...
            cards: [
                ...
                },
                {
                    ...
                    description: 'Refine one entity’s structure, appearance, physics settings, and controller code while developing a vehicle or machine.',
                    entry: 'Aim at an entity, press C, and open the editor’s AI assistant.',
                    example: 'Change only this off-road vehicle: adjust its suspension geometry and damping, then update its controller.',
                ...
                },
                {
                    ...
                    title: 'General agent in the HUD',
                    status: 'AI BUILD available',
                    scope: 'Worlds and entities authorized for your account',
                    description: 'Query your position, build scenes, and coordinate multiple entities for tasks that extend beyond a single object.',
                    entry: 'Choose AI BUILD in the HUD and describe what you want to build.',
