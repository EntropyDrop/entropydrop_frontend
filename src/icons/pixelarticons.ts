const pixelarticons = {
  ...
  "icons": {
    ...
    "buildings": {
      "body": "<path fill=\"currentColor\" d=\"M2 2h14v4h6v16H2zm18 6h-4v2h2v2h-2v2h2v2h-2v2h2zm-6-4H4v16h2v-2h6v2h2zM6 6h2v2H6zm6 0h-2v2h2zm-6 4h2v2H6zm6 0h-2v2h2zm-6 4h2v2H6zm6 0h-2v2h2z\"/>",
      "hidden": true
    },
    "bullseye": {
