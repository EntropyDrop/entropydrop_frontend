...
`entropydrop_space_engine/proto/` owns the shared contracts: `inventory.proto`
(portable resource, v7), `backpack.proto` (browser-local state, v8) and
`space_api.proto` (binary REST request envelopes, v2). See
[`proto/README.md`](../../../entropydrop_space_engine/proto/README.md) for the
...
`entropydrop_space_engine/src/contraption/ScriptApiContract.ts`. Edit that
