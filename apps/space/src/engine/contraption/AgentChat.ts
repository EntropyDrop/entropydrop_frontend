...
## Component API (self)
- Identity/tree/state: self.id, self.parentId, self.state, self.child(id), self.children(). Blueprint child definitions may set collisionEnabled:false for visual-only parts such as raycast wheels; entity copy/export/import preserves this flag.
